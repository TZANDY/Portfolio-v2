  ...
  return (
    <div className="home__social flex flex-col p-4 w-16 sd:flex-row animate-pulse transition">
      ...
      <a href="https://www.facebook.com/Andi.Infante.S" target="_blank" title="Facebook" rel="noreferrer">
        <FaFacebook className="text-2xl text-blue-700  m-1 transition hover:text-green-400 dark:text-slate-200 hover:animate-jump" />
      </a>
      <a href="https://www.linkedin.com/in/andi-inf-sil/" target="_blank" title="Linkedin" rel="noreferrer" >
        <FaLinkedin className="text-2xl text-blue-700  m-1  transition hover:text-green-400 dark:text-slate-200 hover:animate-jump" />
      </a>
