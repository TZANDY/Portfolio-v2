    ...
    <div className="grid grid-cols-3 p-10 items-center justify-center">
      <div className="flex justify-center items-center flex-col">
        <svg
          viewBox="0 0 512 512"
          fill="currentColor"
          className="dark:text-yellow-400 w-8"
        >
          <path
            stroke="currentColor"
            strokeMiterlimit={10}
        ...
        <h3 className="dark:text-blue-400">Experience</h3>
        <span className="dark:text-blue-400">+3 Years in TI</span>
      </div>
      ...
      <div className="flex justify-center items-center flex-col">
        ...
        <h3 className="dark:text-cyan-400">Completed</h3>
        <span className="dark:text-cyan-400">+5 Projects</span>
      </div>
      ...
      <div className="flex justify-center items-center flex-col">
        ...
        <h3 className="dark:text-sky-300">Support</h3>
        <span className="dark:text-sky-300">Online 24/7</span>
      </div>
    </div>
  );
};
